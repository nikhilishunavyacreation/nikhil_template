...
function typeMessage() {
    const messages = [
        ...
        "Your friendship gives me strength and happiness.",
...
function shareOnSocial(platform) {
    ...
    switch(platform) {
        case 'facebook':
            ...
            break;
        case 'instagram':
            url = `https://www.instagram.com/=${encodeURIComponent(text)}`;
            break;
        case 'whatsapp':
    ...
    gsap.to(`.social-icon:nth-child(${['facebook', 'Instagram', 'whatsapp'].indexOf(platform) + 1})`, {
        scale: 1.3,
        duration: 0.3,
        yoyo: true,
        repeat: 1
